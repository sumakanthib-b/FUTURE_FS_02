...
Status Module → Updates lead status (New / Contacted / Converted)

Notes Module → Adds follow-up notes

Analytics Page → Shows total leads & conversion rate
...
Basic analytics (Total Leads, Conversion Rate)
